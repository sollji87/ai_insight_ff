  ...
  brands: [
    {
      ...
      metrics: [
        ...
        { label: "기말재고", value: "3,594.2억 (106.0%)", tone: "down" },
        { label: "ACC재고주수", value: "32.1주 (+6.8주)", tone: "down" },
        { label: "25F M/U", value: "5.16 (+0.00)", tone: "neutral" },
    ...
    },
    {
      ...
      metrics: [
        ...
        { label: "기말재고", value: "5,421.6억 (100.0%)", tone: "neutral" },
        { label: "ACC재고주수", value: "32.2주 (+1.7주)", tone: "neutral" },
    ...
    },
    {
      ...
      metrics: [
        ...
        { label: "기말재고", value: "1,161.1억 (102.0%)", tone: "neutral" },
        { label: "ACC재고주수", value: "33.8주 (+3.1주)", tone: "down" },
    ...
    },
    {
      ...
      metrics: [
        ...
        { label: "기말재고", value: "540.6억 (132.0%)", tone: "down" },
        { label: "ACC재고주수", value: "146.3주 (+66.9주)", tone: "down" },
        { label: "25F M/U", value: "5.88 (+0.68)", tone: "up" },
    ...
    },
    {
      ...
      metrics: [
        ...
        { label: "기말재고", value: "336.5억 (96.0%)", tone: "up" },
        { label: "ACC재고주수", value: "226.8주 (+131.5주)", tone: "down" },
        { label: "25F M/U", value: "3.67 (+0.01)", tone: "up" },
    ...
    rows: [
      ...
      },
      {
        ...
        cells: [
          ...
          { content: "5.3%", tone: "up" },
          { content: "3,594.2억", tone: "down" },
          { content: "32.1주", tone: "down" },
          { content: "5.16" },
          { content: "173" },
        ],
      },
      ...
      },
      {
        ...
        cells: [
          ...
          { content: "28.9%" },
          { content: "540.6억", tone: "down" },
          { content: "146.3주", tone: "down" },
          { content: "5.88", tone: "up" },
          { content: "59" },
        ],
      },
      {
        ...
        cells: [
          ...
          { content: "336.5억", tone: "up" },
          { content: "226.8주", tone: "down" },
