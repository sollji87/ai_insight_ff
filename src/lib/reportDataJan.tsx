...
export const januaryReport: ReportData = {
  ...
  brands: [
    {
      ...
      metrics: [
        ...
        { label: "직접이익률", value: "27.1% (+2.8%p)", tone: "up" },
    ...
    },
    {
      ...
      metrics: [
        ...
        { label: "직접이익률", value: "26.1% (-2.8%p)", tone: "warn" },
    ...
    },
    {
      ...
      metrics: [
        ...
        { label: "직접이익률", value: "3.9% (+1.0%p)", tone: "neutral" },
    ...
    },
    {
      ...
      metrics: [
        ...
        { label: "직접이익률", value: "34.1% (+10.7%p)", tone: "up" },
    ...
    },
    {
      ...
      metrics: [
        ...
        { label: "직접이익률", value: "-55.6% (-27.9%p)", tone: "down" },
  ...
  table: {
    columns: ["브랜드", "실판매출", "YoY", "영업이익", "OPM", "직접이익률", "할인율", "25F 판매율", "신발재고(주)", "자사몰이익률"],
    rows: [
      {
        label: "전사 합계",
      ...
      },
      {
        ...
        cells: [
          ...
          { content: "3.9%" },
          { content: "7.7%" },
          { content: "41.1%", badgeTone: "red" },
          { content: "133.0주", tone: "down" },
          { content: "54.3%" },
        ],
      },
      {
      ...
      },
      {
        ...
        cells: [
          ...
          { content: "34.1%", tone: "up" },
          { content: "24.4%" },
          { content: "47.7%", badgeTone: "green" },
          { content: "29.1주" },
          { content: "69.0%", tone: "up" },
        ],
      },
      {
        label: "🎾 S.TACCHINI",
        cells: [
          ...
          { content: "-55.6%", tone: "down" },
          { content: "35.7%", tone: "down" },
          { content: "30.4%", badgeTone: "red" },
